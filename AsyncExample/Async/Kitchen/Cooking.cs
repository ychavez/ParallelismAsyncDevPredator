...
namespace AsyncExample.Async.Kitchen
{
    public class Cooking
    {
        ...
        public static async Task FryEggsAsync() { await Task.Delay(1000); System.Console.WriteLine("Eggs Ready"); }       
         public static async Task FryBaconAsync() { await Task.Delay(1000);  System.Console.WriteLine("Bacon Ready"); }  
